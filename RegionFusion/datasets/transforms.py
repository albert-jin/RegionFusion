...
def random_crop(image, label=None, crop_size=None, mean_rgb=[0,0,0], ignore_index=255, category_guided=True):
    ...
    H_start, H_end, W_start, W_end = get_random_cropbox(label if category_guided else None)
